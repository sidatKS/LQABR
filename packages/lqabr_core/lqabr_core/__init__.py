...
- crm:          CRMClient interface + HubSpotClient (HubSpot is the system of record)
- timezones:    EST/CST/PST/IST helpers for the Scheduling Agent
- model:        build_model() — Gemini string passthrough, or ADK LiteLlm
                wrapper for other providers (e.g. Anthropic/Claude)
"""
...
from lqabr_core.model import build_model  # noqa: F401
